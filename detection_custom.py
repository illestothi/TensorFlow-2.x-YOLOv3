...
# image_path   = "./IMAGES/00768.jpg"
# image_path   = "./IMAGES/00776.jpg"
video_path   = "./IMAGES/demo.mp4"

yolo = Load_Yolo_model()
detect_image(yolo, image_path, "./IMAGES/res.jpg", input_size=YOLO_INPUT_SIZE, show=True, CLASSES=TRAIN_CLASSES, rectangle_colors=(255,0,0))
